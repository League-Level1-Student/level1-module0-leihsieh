...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if(guess.equalsIgnoreCase("arnold")) {
			JOptionPane.showMessageDialog(null, "Correct! Your score was increased by 1.");
			score++;
		}
		// 6. Otherwise:
		...
		if(guess2.equalsIgnoreCase("Leo")) {
			JOptionPane.showMessageDialog(null, "Correct! Your score was increased by 1.");
			score++;
		}
		else {
			JOptionPane.showMessageDialog(null, "Incorrect! This is Leo.");
		}
		showNextImage();
